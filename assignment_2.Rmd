...
The apriori algorithm produced 12 item set.They have a very low count and only the top 5 has a relatively high confidence level. Stables are often bought together with items such as chairs, vaccume, xerox, envelop, legal cart, post binders, table. Many of the items that are bought together with staples belong to office supply category. 
